...
module purge
module load openmpi/4.1.6 cuda/12.4-share
source /opt/rh/devtoolset-11/enable
export PATH=$PATH:/share/public/PWMLFF_test_data/pfsuo/MatPL-pro/ADA89/bin
export NEP_GPU_LIB_PATH=/share/public/PWMLFF_test_data/pfsuo/MatPL-pro/ADA89/lib64/libnep_gpu.so
