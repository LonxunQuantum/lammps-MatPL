...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--potential", default="../nep4.txt", help="NEP potential file visible from lmps-infer-nep4")
    parser.add_argument("--reference-model", default="nep4", help="MatPL reference result prefix, e.g. nep4 or nep5")
