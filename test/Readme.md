...
```bash
mpirun -np 1 --bind-to numa lmp -k on g 1 -sf kk -pk kokkos -in lmp.in
```

> **单 GPU 无 MPI 模式**（用于 4090 队列 sbatch 提交）：
> ```bash
> export CUDA_VISIBLE_DEVICES=0
> lmp -k on g 1 -sf kk -pk kokkos -in lmp.in
> ```
...
**MatPL-2026.3-p2** (2026-06-23)：**24/24 PASS**

| 体系 | NPT direct | NPT rerun | NVT direct | NVT rerun |
|------|-----------|-----------|-----------|-----------|
| HfO2 | PASS | PASS | PASS | PASS |
| water | PASS | PASS | PASS | PASS |
| C | PASS | PASS | PASS | PASS |
| Cu | PASS | PASS | PASS | PASS |
| W | PASS | PASS | PASS | PASS |
| WMoTaV | PASS | PASS | PASS | PASS |

详细报告见 [test_report.txt](test_report.txt)。
