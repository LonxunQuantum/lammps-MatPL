...
struct NEP3_Data {
  ...
  GPU_Vector<float> force_per_atom;
  GPU_Vector<float> virial_per_atom;
  GPU_Vector<float> total_virial;
...
public:
  ...
  void compute_large_box_optim(
    ...
    float* position_cpu, // postion of atoms x, [n_all * 3]
    float* cpu_potential_per_atom, // the output of ei
    float* cpu_force_per_atom,     // the output of force
    float* cpu_total_virial     // the output of virial
    );
