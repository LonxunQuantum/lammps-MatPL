...
void NEP3_CPU::compute_with_dftd3(
  const std::string& xc,
...
void NEP3_CPU::find_latent_space(
  const std::vector<int>& type,
  const std::vector<double>& box,
  const std::vector<double>& position,
...
void NEP3_CPU::find_polarizability(
  const std::vector<int>& type,
  const std::vector<double>& box,
  const std::vector<double>& position,
  ...
  int model_index)
{
  ...
  find_force_radial_for_lammps( 
    ...
    // for (int i = 0; i < N; i++) {
    //   printf("find_force_radial energy ei[%d] = %f f=%f %f %f\n", i, potential[i], force[i][0], force[i][1], force[i][2]);
    // }
    // for (int i = N; i < nlocal+10; i++) {
    //   printf("find_force_radial i>N f[%d]=%f %f %f\n", i, force[i][0], force[i][1], force[i][2]);
    // }
  find_force_angular_for_lammps(
    ...
    // for (int i = 0; i < N; i++) {
    //   printf("find_force_angular energy ei[%d] = %f f=%f %f %f\n", i, potential[i], force[i][0], force[i][1], force[i][2]);
    // }
    // for (int i = N; i < nlocal+100; i++) {
    //   printf("find_force_angular i>N f[%d]=%f %f %f\n", i, force[i][0], force[i][1], force[i][2]);
    // }
